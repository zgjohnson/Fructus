...
let fruitsData:  [Fruit] = [
    Fruit(
        ...
        description: """
          ...
          Commercial blueberries—both wild (low-bush) and cultivated (high-bush)—are all native to North America. The high-bush varieties were introduced into Europe during the 1930s.

          Blueberries are usually prostrate shrubs that can vary in size from 10 centimeters (3.9 in) to 4 meters (13 ft) in height. In commercial production of blueberries, the species with small, pea-size berries growing on low-level bushes are known as "low-bush blueberries" (synonymous with "wild"), while the species with larger berries growing on taller cultivated bushes are known as "high-bush blueberries".

          Canada is the leading producer of low-bush blueberries, while the United States produces some 40% of the world supply of high-bush blueberries.
          ...
          Blueberry wine is made from the flesh and skin of the berry, which is fermented and then matured; usually the low-bush variety is used.
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        nutrition: ["136 kJ (33 kcal)","4.89 g","0.3 g","0.67 g","B1, B2, B3, B5, B6, B9, Choline, C, E, K","Calcium, Iron, Magnesium, Manganese, Phosphorus, Potassium, Sodium, Zinc"]
      ),
      Fruit(
        title: "Lemon",
        ...
        description: """
          ...
          Lemons contain numerous phytochemical, including polyphenols, terpenes, and tannins.[14] Lemon juice contains slightly more citric acid than lime juice (about 47 g/l), nearly twice the citric acid of grapefruit juice, and about five times the amount of citric acid found in orange juice.
      ...
      Fruit(
        ...
        description: """
          ...
          Fruits are usually of medium size, between 2 and 7 centimeters in diameter, globose to oval. The flesh is firm and juicy. The fruit's peel is smooth, with a natural waxy surface that adheres to the flesh. The plum is a drupe, meaning its fleshy fruit surrounds a single hard seed.
